...
> The Hello Rails React App is an example of a API Rails app connected to React fetching its API endpoint. It renders a random greeting message.
...
- Ruby
- Node
- Basic HTML, CSS, JavaScript, React and Ruby knowledge.
...
```sh
  cd my-folder
  git clone https://github.com/Mar12358/hello-rails-react.git
```
